...
| プラグイン | バージョン | 説明 |
|-----------|-----------|------|
| [git-actions](./plugins/git-actions/) | 1.2.2 | Git commit and push workflow management for Claude Code |
| [image-gen-gemini](./plugins/image-gen-gemini/) | 1.0.2 | Gemini CLI (Nano Banana Pro) を使用した AI 画像生成 |
| [plugin-generator](./plugins/plugin-generator/) | 1.0.4 | Claude Code プラグインのスキャフォールディングとバリデーション |
