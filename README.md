...
| [claude-code-spec](./plugins/claude-code-spec/) | 3.0.0 | Claude Code CLI の仕様と使い方を完璧に理解するための知識プラグイン |
...
| [codex-cli-spec](./plugins/codex-cli-spec/) | 3.0.0 | OpenAI Codex CLI の仕様と使い方を完璧に理解するための知識プラグイン |
