...
| claude-code-spec | 1.1.0 | Claude Code CLI の仕様と使い方を完璧に理解するための知識プラグイン |
| cloudflare-knowledge | 1.1.0 | Cloudflare のサービス、Wrangler CLI、Workers/Pages 開発、Terraform 管理、セキュリティ機能に関する包括的な知識プラグイン |
| codex-cli-spec | 1.3.0 | OpenAI Codex CLI の仕様と使い方を完璧に理解するための知識プラグイン |
...
| plugin-generator | 1.3.0 | Claude Code プラグインのスキャフォールディングとバリデーション |
