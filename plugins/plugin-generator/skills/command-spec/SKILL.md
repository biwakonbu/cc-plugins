---
name: command-spec
description: Use when creating, updating, or maintaining commands, understanding command structure, or implementing slash commands. Also use when user says コマンド, スラッシュコマンド, commands. Claude Code プラグインの command 仕様知識で、スラッシュコマンドの正しい形式、フロントマター、変数、model 指定を提供する。
context: fork
