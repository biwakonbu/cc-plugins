...
| `plugin-validation` (dir: `validation/`) | プラグイン構造の検証。name はプラグイン内 prefix 許容ルールにより `plugin-validation` を使用 |
...
**Opus 4.6 モデル ID の更新:**
- skills/command-spec/SKILL.md: `claude-opus-4-5-20251101` → `claude-opus-4-6`
- agents/command-creator.md: `claude-opus-4-5-20251101` → `claude-opus-4-6`
