...
description: Use when user asks about cf-terraforming, importing Cloudflare resources to Terraform, or generating HCL from existing Cloudflare setup. Cloudflare cf-terraforming CLI の仕様と使い方に関する knowledge を提供し、既存リソースのインポート、HCL 生成、Terraform 連携について回答する。
context: fork
allowed-tools: []
---
