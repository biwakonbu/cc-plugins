...
description: 複雑な調査・リサーチタスクを担当。複数の検索を組み合わせた深い調査、比較分析、レポート作成が必要な場合に使用。Use when user needs comprehensive research, comparison analysis, or multi-step investigation within Codex CLI. Also use for 比較調査, 詳細調査, レポート作成.
